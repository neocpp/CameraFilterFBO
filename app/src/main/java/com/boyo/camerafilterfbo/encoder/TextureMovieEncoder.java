...
public class TextureMovieEncoder implements Runnable {
    ...
    private EncodeDrawer mFullScreen;
    ...
    private void handleUpdateSharedContext(EGLContext newSharedContext) {
        ...
        EncodeDrawer olddrawer = mFullScreen;
        mFullScreen = new EncodeDrawer(mContext);
        mFullScreen.setSurfaceSize(olddrawer.getSurfaceWidth(), olddrawer.getSurfaceHeight());
    }
    ...
    private void prepareEncoder(EGLContext sharedContext, int width, int height, int bitRate,
        ...
        mFullScreen = new EncodeDrawer(mContext);
        mFullScreen.setSurfaceSize(width, height);
    }
